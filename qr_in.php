...
<div class="container-fluid">
    ...
    <div class="container-fluid">
    <div class="col-md-9">
        <h1 class="page-header">DTC TRAINING - Qr Attendance and Login</h1>
        <div class="table-responsive">
            <table class="table table-hover">

    <div class="text-center">
        <!-- Image above the QR Scanner -->
        <img id="qrImage" src="assets/qr.png" alt="QR Code Placeholder" 
    ...
    <p class="text-center"><strong>Scan your QR code to mark attendance.</strong></p>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body d-flex align-items-center justify-content-center" style="display: flex; flex-wrap: wrap; align-items: center; text-align: left; padding: 20px;">
        ...
        <div style="flex: 1; text-align: center;">
          <img id="modalImage" src="assets/qr.png" alt="QR Code" class="img-responsive full-screen-img" style="max-width: 80%; height: auto;">
        </div>
...
$(document).ready(function () {
   ...
   $("#printQR").click(function () {
    ...
    printWindow.document.write('<img src="assets/qr.png" alt="QR Code" style="width: 100%; height: auto;">');
