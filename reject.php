...
$query = "SELECT * FROM training_content WHERE status = 'rejected'";
...
<div class="container-fluid">
    <div class="col-md-3">
        <div id="sidebar">
            ...
            <ul class="nav navbar-nav side-bar">
                ...
                <li class="side-bar"><a href="qr_in.php"><span class="glyphicon glyphicon-qrcode"></span> Qr In</a></li>
                </li>
     <li class="side-bar">
        <a href="foot_track.php">
            <span class="glyphicon glyphicon-qrcode"></span> Qr in Foot Traffic
                ...
                <li class="side-bar"><a href="add_user.php"><span class="glyphicon glyphicon-qrcode"></span> Add User</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="col-md-9">
            <h1 class="page-header">DTC TRAINING - Rejected Trainings</h1>
            <div class="table-responsive">
                <table id="rejectedTable" class="table table-hover table-bordered">
                    <thead>
                        <tr>
                            <th>Ideas</th>
                            <th>Title</th>
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<tr><td colspan='5' class='text-center'>No rejected reports found.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
...
$(document).ready(function() {
    // Initialize DataTables for rejectedTable
    $('#rejectedTable').DataTable({
        dom: 'Blfrtip',
        buttons: [
            'copy', 'csv', 'excel', 'pdf', 'print'
        ],
        order: [[3, "desc"]],  // Order by time column (4th column)
        responsive: true,
        initComplete: function() {
            // Integrate with custom search input
            var api = this.api();
