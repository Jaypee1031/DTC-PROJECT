...
// Fetch training data from the user_trainings table, ordered by created_at in descending order
$sql = "SELECT id, Ideas, title, description, created_at, Status, username 
        FROM user_trainings 
        ORDER BY id DESC"; // Added ORDER BY clause
...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        <div class="col-md-9">
            <h1 class="page-header">DTC TRAINING - User Trainings</h1>
...
if ($result->num_rows > 0) {
    ...
    echo "<tr><td colspan='6' class='text-center'>No user trainings found.</td></tr>";
}
?>
                    </tbody>
                </table>
